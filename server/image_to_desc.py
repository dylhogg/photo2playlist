            ...
            messages=[
                {
                    ...
                    "content": [
                        {
                            "type": "text",
                            "text": "Describe this image in 1-2 sentences, focusing on the mood, atmosphere, setting, and key visual elements that would inspire a music playlist. Be descriptive and evocative."
                        },
                        {
                            "type": "image_url",
                            "image_url": {
